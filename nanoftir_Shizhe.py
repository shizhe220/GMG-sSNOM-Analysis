...
# CHT / real-space cavity model (Hankel, 1/sqrtx) / FFT dispersion-fitting engine and
# the CHT-vs-Hankel-vs-1-sqrtx comparison plots -- migrated 2026-07-08 to
# snippet/dispersion_fitting.py so CrSBr_Analysis/G-CIPS/future dispersion-fitting
# projects share one maintained copy instead of forking their own (see
# envsetting/dispersion_fitting_migration_plan.md). Re-exported here so existing
# notebook cells calling nanoftir.fit_and_plot_cht(...) etc. keep working unchanged.
from snippet.dispersion_fitting import (
