...
graphene_4x1_manual lp2 (right edge) dataset, using the parameters currently
tuned in fitting_pipeline_graphene_4x1_lp2.ipynb. Saves to
figures/graphene_4x1_manual/lp2/fit_comparison/{wn}_{combined,panels}.png.
...
are scoped to lp='lp2' (data/graphene_4x1_manual/ holds both lp1 and lp2 CSVs
