"""Export a CSV summary from data/fit_results_graphene_3x1_manual.pkl: per-wn
...
Sibling of scripts/export_comparison_csv.py, pointed at the
graphene_3x1_manual dataset."""
import json
import re
import pickle
import os
...
# the relative paths below ('data/...', notebook path) resolve the same way
...
OUT_CSV = 'data/cht_vs_realspace_wavelength_comparison_graphene_3x1_manual.csv'
