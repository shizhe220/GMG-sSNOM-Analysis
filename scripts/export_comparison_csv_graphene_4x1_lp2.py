"""Export a CSV summary from data/fit_results_graphene_4x1_lp2.pkl: per-wn
...
Sibling of scripts/export_comparison_csv_graphene_4x1_lp1.py, pointed at
the graphene_4x1_manual lp2 (right edge) dataset."""
import json
import re
import pickle
import os
...
OUT_CSV = 'data/cht_vs_realspace_wavelength_comparison_graphene_4x1_lp2.csv'
