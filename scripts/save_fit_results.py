...
# the relative paths below ('data/...', 'figures/...', 'fitting_pipeline.ipynb')
# resolve the same way they did back when this script lived at the repo root.
...
# anywhere earlier in the notebook (this bit us once already). Instead, locate
# each wn's own "target_wn = '...'" select cell and use it as an anchor: the
# per-wn template always lays out select -> CHT (+2) -> real-space (+4) -> FFT (+6).
select_idx = {}
