...
parameters currently tuned in fitting_pipeline_graphene_4x1_lp1.ipynb, and
save a results dict (lambda_p, momentum q, damping per method) to
data/fit_results_graphene_4x1_lp1.pkl.

Sibling of scripts/save_fit_results.py, pointed at the graphene_4x1_manual lp1 (left edge)
...
SAVE_DIR = 'figures/graphene_4x1_manual/lp1'
PICKLE_PATH = 'data/fit_results_graphene_4x1_lp1.pkl'

# graphene_4x1_lp1's CSVs were already aligned during manual extraction
