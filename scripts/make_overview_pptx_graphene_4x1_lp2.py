...
lp2 (right edge) dataset: one title slide, one slide per wavenumber (CHT figure
on top, real-space + FFT figures below), and a closing summary table slide.

Sibling of scripts/make_overview_pptx_graphene_4x1_lp1.py, pointed at
graphene_4x1_manual/lp2."""
import csv
import os
...
FIG_DIR = 'figures/graphene_4x1_manual/lp2'
CSV_PATH = 'data/cht_vs_realspace_wavelength_comparison_graphene_4x1_lp2.csv'
OUT_PPTX = 'slides/GMG_CHT_overview_graphene_4x1_lp2.pptx'
...
add_text(s, Inches(0.9), Inches(4.95), Inches(11.5), Inches(0.5),
         ...
         "(lp2, right edge — manually-extracted+aligned linecuts from processed_4x1um/860-1000_AVG.npz)",
         13, ICE, italic=True)
