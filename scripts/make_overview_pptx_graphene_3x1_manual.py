"""Build the CHT/Hankel/1-sqrtx/FFT overview deck for the graphene_3x1_manual
dataset: one title slide, one slide per wavenumber (CHT figure on top,
real-space + FFT figures below), and a closing summary table slide. Reads
figures/graphene_3x1_manual/{cht,realspace,fft}/*.png and
data/cht_vs_realspace_wavelength_comparison_graphene_3x1_manual.csv -- run
after scripts/save_fit_results_graphene_3x1_manual.py +
scripts/export_comparison_csv_graphene_3x1_manual.py.

Sibling of scripts/make_overview_pptx.py, pointed at graphene_3x1_manual."""
import csv
import os
...
FIG_DIR = 'figures/graphene_3x1_manual'
CSV_PATH = 'data/cht_vs_realspace_wavelength_comparison_graphene_3x1_manual.csv'
OUT_PPTX = 'slides/GMG_CHT_overview_graphene_3x1_manual.pptx'
...
add_text(s, Inches(0.9), Inches(4.95), Inches(11.5), Inches(0.5),
          "860–1000 cm⁻¹  ·  nano-FTIR amplitude line profiles  ·  graphene_3x1_manual dataset "
          "(manually-extracted+aligned linecuts from processed_3x1um/*.npz)", 13, ICE, italic=True)
