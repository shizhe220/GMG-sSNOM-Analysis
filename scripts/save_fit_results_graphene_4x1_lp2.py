...
parameters currently tuned in fitting_pipeline_graphene_4x1_lp2.ipynb, and
save a results dict (lambda_p, momentum q, damping per method) to
data/fit_results_graphene_4x1_lp2.pkl.

Sibling of scripts/save_fit_results.py, pointed at the graphene_4x1_manual lp2 (right edge)
...
NOTEBOOK_PATH = 'fitting_pipeline_graphene_4x1_lp2.ipynb'
DATA_DIR = 'data/graphene_4x1_manual'
SAVE_DIR = 'figures/graphene_4x1_manual/lp2'
PICKLE_PATH = 'data/fit_results_graphene_4x1_lp2.pkl'

# graphene_4x1_lp2's CSVs were already aligned during manual extraction
...
for wn, p in wn_params.items():
    ...
    results, _ = nanof.run_wn_comparison(
        ...
        data_dir=DATA_DIR, lp='lp2', save_dir=SAVE_DIR, show=False)
